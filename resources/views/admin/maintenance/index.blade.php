...
@section('main-content')
    ...
    <section class="content">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li class="btn btn-info btn-xs"><a href="#"><i class="fa fa-user"></i> {{count($maintenance_initial)}} etudiants</a>  </li>
          <li class="btn btn-primary btn-xs">Prix unique : 20000 f</li>
          <li class="btn btn-success btn-xs">Prix total : {{ 20000 * count($maintenance_initial)}} f</li>
        </ol>
      </section>
        <div class="box-body">
                    <!-- debut de la table -->
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="activity">
              <table id="example1" class="table text-center table-bordered table-striped">
                ...
                <tbody>
                  @foreach($maintenance_initial as $initiale)
                  <tr>
    ...
    <!-- Fin du modal des edtions -->
      @foreach($maintenance_initial as $modal_initiale)
      ...
      <!-- FIN DE LA PARTIE DES MODAL -->
           ...
           <!-- Fin du modal des edtions -->
      @foreach($maintenance_initial as $modal_initial)
        <div class="modal fade" id="modal-default-payment-initiale-{{ $modal_initial->id }}">
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <form action="{{ route('maintenance.payment',$modal_initial->id) }}" method="post">
              @csrf
              {{ method_field('PUT') }}
              <div class="modal-body">
                  <div class="row">
