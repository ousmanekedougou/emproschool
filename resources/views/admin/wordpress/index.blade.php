...
@section('main-content')
    ...
    <section class="content">
      ...
      <div class="">
        ...
        <ol class="breadcrumb">
          ...
          <li class="btn btn-success btn-xs">Prix total : {{ 15000 * count($wordpress_price)}} f</li>
        </ol>
      </section>
        </div>
        <div class="box-body">
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="activity">
              <table id="example1" class="table text-center responsive-table table-bordered table-striped">
                ...
                <tbody>
                  @foreach($wordpress_initial as $webinit)
                  <tr>
    ...
    <!-- Fin du modal des edtions -->
      @foreach($wordpress_initial as $modal_initiale)
