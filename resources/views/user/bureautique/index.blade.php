    ...
    <header class=" row site-header" style="text-align:center;">
     ...
     <div class="row">
      ...
      <p class="text_description">
        <strong>Objectifs :</strong> Acquérir les bases essentielles pour concevoir des documents simples avec le logiciel Word, faire des calculs avec le logiciel Excel, et faire des présentations avec le logiciel Powerpoint. Savoir organiser son travail dans les logiciels pour concevoir rapidement tous types de documents gagner un temps précieux par la maîtrise des fonctionnalités avancées de ces logiciels
      </p>
      <p class="text_description">
